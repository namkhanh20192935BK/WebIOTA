...
function(a) {
    a(document).on("init", function() {
        ...
        a(document).on("click", "#file-upload-form", function() {
            a("#file-upload").trigger("click")
        });
        var c = {
            success: function() {
        ...
        a(document).on("change", "#file-upload", function() {
            var ufile = this.files[0]
              , filereader = new FileReader;
            filereader.onloadend = function(filereader) {
                var e = b(filereader.target.result);
                a("#image-map").imageMapper("update", {
                    src: "data:" + ufile.type + ";base64," + e,
                    file: ufile.name
                })
            }
            ,
            console.log("Varibale",ufile);
            ufile ? filereader.readAsArrayBuffer(ufile) : a("#image-map").imageMapper("update", {
                src: "",
                file: ""
            })
        }) 
