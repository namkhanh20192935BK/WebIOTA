  ...
  cout = 0;
    ...
    function drawChartLeft() {
      var data = google.visualization.arrayToDataTable([
        ['Chart','Benign','Borderline Cancer','Stage I Cancer','Stage II-IV Cancer','Metastatic Cancer'],
        ['Baseline Risks', 68.1, 6.3, 7.5, 14.1, 4.0],
        ['Patient Risks', P_Benign, P_Borderline, P_stageICancer, P_stageII_IVCancer, (100 - P_Benign).toFixed(1) - P_Borderline - P_stageICancer - P_stageII_IVCancer]
      ]);
    ...
    if(checkRightOvary == true){
      ...
      function drawChartRight() {
        var data = google.visualization.arrayToDataTable([
          ['Chart','Benign','Borderline Cancer','Stage I Cancer','Stage II-IV Cancer','Metastatic Cancer'],
          ['Baseline Risks', 68.1, 6.3, 7.5, 14.1, 4.0],
          ['Patient Risks', P_BenignR, P_BorderlineR, P_stageICancerR, P_stageII_IVCancerR, (100 - P_BenignR).toFixed(1) - P_BorderlineR - P_stageICancerR - P_stageII_IVCancerR]
        ]);
