   ...
   // alert(irregularSolidTumorCheck + " " + unilocularCheck + " " + ascitesCheck +" " + solidComponentsCheck +" "+papillaryStructuresCheck +" "+ acousticShadowsCheck + " " + irregularMultilocularTumorCheck + " " + smothMultilocularTumorCheck + " " + strongBloodFlowCheck + " " + noBloodFlowCheck);
    ...
    if(checkboxL.checked){
      ...
      if(checkPoint_Left== 1){
          addAlert("Buồng trứng trái: Theo Thông tin Kết quả Siêu âm, CÓ NGUY CƠ ÁC TÍNH THẤP, theo Quy tắc Đơn giản của Nhóm Phân tích Khối u Buồng trứng Quốc tế (IOTA).","text-diagnosis-results-left");
          addAlert("Buồng trứng trái: Chỉ áp dụng các đặc điểm điển hình cho khối u lành tính (đặc điểm B), không có đặc điểm nào điển hình cho khối u ác tính (đặc điểm M).","text-diagnosis-comments-left");
        }
      if(checkPoint_Left === 2){
            addAlert("Buồng trứng trái: Theo Thông tin Kết quả Siêu âm, CÓ NGUY CƠ ÁC TÍNH CAO, theo Quy tắc Đơn giản của Nhóm Phân tích Khối u Buồng trứng Quốc tế (IOTA).","text-diagnosis-results-left");
            addAlert("Buồng trứng trái: Chỉ áp dụng các đặc điểm điển hình cho khối u ác tính (đặc điểm M), không có đặc điểm nào điển hình cho khối u lành tính (đặc điểm B).","text-diagnosis-comments-left");
        }
      if(checkPoint_Left === 0){
            addAlert("Buồng trứng trái: Theo Thông tin Kết quả Siêu âm, CÓ RỦI RO ÁC TÍNH CHƯA XÁC ĐỊNH, theo Quy tắc Đơn giản của Nhóm Phân tích Khối u Buồng trứng Quốc tế (IOTA).","text-diagnosis-results-left");
            addAlert("Buồng trứng trái: Không áp dụng đặc điểm nào hoặc áp dụng cả đặc điểm B và đặc điểm M.","text-diagnosis-comments-left");
        }
    } 
    ...
    if(checkPoint_Right== 1){
        addAlert("Buồng trứng phải: Theo Thông tin Kết quả Siêu âm, CÓ NGUY CƠ ÁC TÍNH THẤP, theo Quy tắc Đơn giản của Nhóm Phân tích Khối u Buồng trứng Quốc tế (IOTA).","text-diagnosis-results-right");
        addAlert("Buồng trứng phải: Chỉ áp dụng các đặc điểm điển hình cho khối u lành tính (đặc điểm B), không có đặc điểm nào điển hình cho khối u ác tính (đặc điểm M).","text-diagnosis-comments-right");
      }
    if(checkPoint_Right === 2){
          addAlert("Buồng trứng phải: Theo Thông tin Kết quả Siêu âm, CÓ NGUY CƠ ÁC TÍNH CAO, theo Quy tắc Đơn giản của Nhóm Phân tích Khối u Buồng trứng Quốc tế (IOTA).","text-diagnosis-results-right");
          addAlert("Buồng trứng phải: Chỉ áp dụng các đặc điểm điển hình cho khối u ác tính (đặc điểm M), không có đặc điểm nào điển hình cho khối u lành tính (đặc điểm B).","text-diagnosis-comments-right");
      }
    if(checkPoint_Right === 0){
          addAlert("Buồng trứng phải: Theo Thông tin Kết quả Siêu âm, CÓ RỦI RO ÁC TÍNH CHƯA XÁC ĐỊNH, theo Quy tắc Đơn giản của Nhóm Phân tích Khối u Buồng trứng Quốc tế (IOTA).","text-diagnosis-results-right");
          addAlert("Buồng trứng phải: Không áp dụng đặc điểm nào hoặc áp dụng cả đặc điểm B và đặc điểm M.","text-diagnosis-comments-right");
      }
    }
    ...
    if(!checkboxL.checked && !checkboxR.checked){
      createToast('warning', 'fa-solid fa-triangle-exclamation', 'Cảnh báo', 'Không có thông tin được nhập');
    }
}
